...
test_data_dir  =  "../../../../data/poetryFoundation/txt_60/"
...
# print '-'*10
# index = similarities.Similarity('tmp/tst', tfidf[corpus] , num_features=10)
...
# cosine_similarities = linear_kernel(corpus_tfidf[0:1], corupus_tfidf).flatten()
